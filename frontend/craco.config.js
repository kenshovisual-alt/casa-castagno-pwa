...
let webpackConfig = {
  ...
  jest: {
    configure: (jestConfig) => {
      // react-router-dom v7 (and its react-router dependency) ship "exports" maps whose
      // default condition is an ESM build; Jest's CJS runtime can't parse those, so map
      // each package (and the react-router/dom subpath) to its CJS dist file directly.
